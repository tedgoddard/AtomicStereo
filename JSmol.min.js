...
g.css(f,"border"+Qa[a]+"Width",!0,b))):(k+=g.css(f,"padding"+Qa[a],!0,b),"padding"!==p&&(k+=g.css(f,"border"+Qa[a]+"Width",!0,b)));return k}function W(f,a,p){var x=!0,b="width"===a?f.offsetWidth:f.offsetHeight,k=Ra(f),c=v.boxSizing()&&"border-box"===g.css(f,"boxSizing",!1,k);if(0>=b||null==b){b=Sa(f,a,k);if(0>b||null==b)b=f.style[a];if(tb.test(b))return b;x=c&&(v.boxSizingReliable()||b===f.style[a]);b=parseFloat(b)||0}return b+y(f,a,p||(c?"border":"content"),x,k)+"px"}function L(f,a,p,b,g){return new L.prototype.init(f,
a,p,b,g)}function ga(){setTimeout(function(){$a=void 0});return $a=g.now()}function O(f,a){var p,b={height:f},g=0;for(a=a?1:0;4>g;g+=2-a)p=Qa[g],b["margin"+p]=b["padding"+p]=f;a&&(b.opacity=b.width=f);return b}function wa(f,a,p){for(var b,g=(jb[a]||[]).concat(jb["*"]),k=0,c=g.length;k<c;k++)if(b=g[k].call(p,a,f))return b}function kb(f,a,p){var b,k,c=0,d=ub.length,n=g.Deferred().always(function(){delete e.elem}),e=function(){if(k)return!1;for(var a=$a||ga(),a=Math.max(0,r.startTime+r.duration-a),u=
...
q.postDispatch.call(this,a);return a.result}},handlers:function(a,b){var c,k,d,n,e=[],r=b.delegateCount,q=a.target;if(r&&q.nodeType&&(!a.button||"click"!==a.type))for(;q!=this;q=q.parentNode||this)if(1===q.nodeType&&(!0!==q.disabled||"click"!==a.type)){d=[];for(n=0;n<r;n++)k=b[n],c=k.selector+" ",void 0===d[c]&&(d[c]=k.needsContext?0<=g(c,this).index(q):g.find(c,this,null,[q]).length),d[c]&&d.push(k);d.length&&e.push({elem:q,handlers:d})}r<b.length&&e.push({elem:this,handlers:b.slice(r)});return e},
...
Uc})}});g.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,b){var c=/Y/.test(b);g.fn[a]=function(k){return Wa(this,function(a,k,f){var d=ba(a);if(void 0===f)return d?b in d?d[b]:d.document.documentElement[k]:a[k];d?d.scrollTo(!c?f:g(d).scrollLeft(),c?f:g(d).scrollTop()):a[k]=f},a,k,arguments.length,null)}});g.each(["top","left"],function(a,b){g.cssHooks[b]=gb(v.pixelPosition,function(a,c){if(c)return c=Sa(a,b),tb.test(c)?g(a).position()[b]+"px":c})});g.each({Height:"height",Width:"width"},
...
Jmol._version||(Jmol=function(a){var m=function(a){return{rear:a++,header:a++,main:a++,image:a++,front:a++,fileOpener:a++,coverImage:a++,dialog:a++,menu:a+9E4,console:a+91E3,consoleImage:a+91001,monitorZIndex:a+99999}},m={_version:"$Date: 2016-04-14 07:09:58 -0500 (Thu, 14 Apr 2016) $",_alertNoBinary:!0,_allowedJmolSize:[25,2048,300],_appletCssClass:"",_appletCssText:"",_fileCache:null,_jarFile:null,_j2sPath:null,_use:null,_j2sLoadMonitorOpacity:90,_applets:{},_asynchronous:!0,_ajaxQueue:[],_persistentMenu:!1,
...
"?call=getRawDataFromDatabase&database="+b+(0<=c.indexOf("?POST?")?"?POST?":"")+"&query="+encodeURIComponent(c)+(h?"&encoding=base64":"")+(l?"":"&script="+encodeURIComponent(a._getScriptForDatabase(b)));return a._contactServer(b,d,e)};a._checkFileName=function(b,c,d){a._isDatabaseCall(c)&&(d&&a._setQueryTerm(b,c),c=a._getDirectDatabaseCall(c,!0),a._isDatabaseCall(c)&&(c=a._getDirectDatabaseCall(c,!1),d&&(d[0]=!0)));return c};a._checkCache=function(b,c,d){if(b._cacheFiles&&a._fileCache&&!c.endsWith(".js")){if(b=
a._fileCache[c])return System.out.println("using "+b.length+" bytes of cached data for "+c),d(b),null;d=function(b,c){d(a._fileCache[b]=c)}}return d};a._loadFileData=function(b,c,d,e){var h=[];c=a._checkFileName(b,c,h);d=a._checkCache(b,c,d);h[0]?a._getRawDataFromServer("_",c,d,e):(b={type:"GET",dataType:"text",url:c,async:a._asynchronous,success:function(b){a._loadSuccess(b,d)},error:function(){a._loadError(e)}},a._checkAjaxPost(b),a._ajax(b))};a._getInfoFromDatabase=function(b,c,d){if("===="==c){var e=
a.db._restQueryXml.replace(/QUERY/,d),e={dataType:"text",type:"POST",contentType:"application/x-www-form-urlencoded",url:a.db._restQueryUrl,data:encodeURIComponent(e)+"&req=browser",success:function(e){a._ajaxDone();a._extractInfoFromRCSB(b,c,d,e)},error:function(){a._loadError(null)},async:a._asynchronous};return a._ajax(e)}d="?call=getInfoFromDatabase&database="+c+"&query="+encodeURIComponent(d);return a._contactServer(d,function(d){a._setInfo(b,c,d)})};a._extractInfoFromRCSB=function(b,c,d,e){var h=
e.length/5;if(0!=h&&4==d.length&&1!=h){d=d.toUpperCase();var l=e.indexOf(d);0<l&&0<="123456789".indexOf(d.substring(0,1))&&(e=d+","+e.substring(0,l)+e.substring(l+5));50<h&&(e=e.substring(0,250));e=e.replace(/\n/g,",");e=a._restReportUrl.replace(/IDLIST/,e);a._loadFileData(b,e,function(d){a._setInfo(b,c,d)})}};a._checkAjaxPost=function(a){var c=a.url.indexOf("?POST?");0<c&&(a.data=a.url.substring(c+6),a.url=a.url.substring(0,c),a.type="POST",a.contentType="application/x-www-form-urlencoded")};a._contactServer=
function(b,c,d){b={dataType:"text",type:"GET",url:a._serverUrl+b,success:function(b){a._loadSuccess(b,c)},error:function(){a._loadError(d)},async:c?a._asynchronous:!1};a._checkAjaxPost(b);return a._ajax(b)};a._setQueryTerm=function(b,c){if(c&&b._hasOptions&&"http://"!=c.substring(0,7)){if(a._isDatabaseCall(c)){var d=c.substring(0,1);c=c.substring(1);c.substring(0,1)==d&&0<="=$".indexOf(d)&&(c=c.substring(1));var e=a._getElement(b,"select");if(e&&e.options)for(var h=0;h<e.options.length;h++)e[h].value==
d&&(e[h].selected=!0)}a.$val(a.$(b,"query"),c)}};a._search=function(b,c,d){1<arguments.length||(c=null);a._setQueryTerm(b,c);c||(c=a.$val(a.$(b,"query")));0==c.indexOf("!")?b._script(c.substring(1)):(c&&(c=c.replace(/\"/g,"")),b._showInfo(!1),a._searchMol(b,c,d,!0))};a._searchMol=function(b,c,d,e){var h;a._isDatabaseCall(c)?(h=c.substring(0,1),c=c.substring(1)):h=b._hasOptions?a.$val(a.$(b,"select")):"$";"="==h&&3==c.length&&(c="="+c);var l=h+c;if(c&&!(0>l.indexOf("?")&&l==b._thisJmolModel)){b._thisJmolModel=
l;var j;e&&null!=b._viewSet&&null!=(j=a.View.__findView(b._viewSet,{chemID:l}))?a.View.__setView(j,b,!1):("$"==h||":"==h?b._jmolFileType="MOL":"="==h&&(b._jmolFileType="PDB"),b._searchDatabase(c,h,d))}};a._searchDatabase=function(b,c,d,e){b._showInfo(!1);return 0<=c.indexOf("?")?(a._getInfoFromDatabase(b,d,c.split("?")[0]),!0):a.db._DirectDatabaseCalls[d]?(b._loadFile(d+c,e),!0):!1};a._syncBinaryOK="?";a._canSyncBinary=function(b){if(a._isAsync)return!0;if(self.VBArray)return a._syncBinaryOK=!1;if("?"!=
a._syncBinaryOK)return a._syncBinaryOK;a._syncBinaryOK=!0;try{var c=new window.XMLHttpRequest;c.open("text",a._ajaxTestSite,!1);c.hasOwnProperty("responseType")?c.responseType="arraybuffer":c.overrideMimeType&&c.overrideMimeType("text/plain; charset=x-user-defined")}catch(d){return System.out.println("JSmolCore.js: synchronous binary file transfer is requested but not available"),a._alertNoBinary&&!b&&alert("JSmolCore.js: synchronous binary file transfer is requested but not available"),a._syncBinaryOK=
!1}return!0};a._binaryTypes=".gz .jpg .gif .png .zip .jmol .bin .smol .spartan .mrc .map .ccp4 .dn6 .delphi .omap .pse .dcd".split(" ");a._isBinaryUrl=function(b){for(var c=a._binaryTypes.length;0<=--c;)if(0<=b.indexOf(a._binaryTypes[c]))return!0;return!1};a._getFileData=function(b,c,d){var e=a._isBinaryUrl(b),h=0<=b.indexOf(".gz")&&0<=b.indexOf("rcsb.org");h&&(b=b.replace(/\.gz/,""),e=!1);var h=e&&!a._canSyncBinary(h),l=0<=b.indexOf("?POST?");0==b.indexOf("file:/")&&0!=b.indexOf("file:///")&&(b=
"file://"+b.substring(5));var j=0>b.indexOf("://")||0==b.indexOf(document.location.protocol)&&0<=b.indexOf(document.location.host),t="https://"==a._httpProto&&0==b.indexOf("http://"),m=a._isDirectCall(b);!m&&0<=b.indexOf("?ALLOWSORIGIN?")&&(m=!0,b=b.replace(/\?ALLOWSORIGIN\?/,""));var s=!j&&a.$supportsIECrossDomainScripting(),w=null;if(t||h||!j&&!m||!c&&s)w=a._getRawDataFromServer("_",b,c,c,h,!0);else{b=b.replace(/file:\/\/\/\//,"file://");var P={dataType:e?"binary":"text",async:!!c};l?(P.type="POST",
P.url=b.split("?POST?")[0],P.data=b.split("?POST?")[1]):(P.type="GET",P.url=b);c&&(P.success=function(){c(a._xhrReturn(P.xhr))},P.error=function(){c(P.xhr.statusText)});P.xhr=a.$ajax(P);c||(w=a._xhrReturn(P.xhr))}if(!d)return w;null==w&&(w="",e=!1);e&&(e=a._canSyncBinary(!0));return e?a._strToBytes(w):JU.SB.newS(w)};a._xhrReturn=function(a){return!a.responseText||self.Clazz&&Clazz.instanceOf(a.response,self.ArrayBuffer)?a.response||a.statusText:a.responseText};a._isDirectCall=function(b){if(0<=b.indexOf("?ALLOWSORIGIN?"))return!0;
for(var c in a.db._DirectDatabaseCalls)if(0<=c.indexOf(".")&&0<=b.indexOf(c))return!0;return!1};a._cleanFileData=function(a){return 0<=a.indexOf("\r")&&0<=a.indexOf("\n")?a.replace(/\r\n/g,"\n"):0<=a.indexOf("\r")?a.replace(/\r/g,"\n"):a};a._getFileType=function(a){var c=a.substring(0,1);if("$"==c||":"==c)return"MOL";if("="==c)return"="==a.substring(1,2)?"LCIF":"PDB";a=a.split(".").pop().toUpperCase();return a.substring(0,Math.min(a.length,3))};a._getZ=function(b,c){return b&&b._z&&b._z[c]||a._z[c]};
a._incrZ=function(b,c){return b&&b._z&&++b._z[c]||++a._z[c]};a._hideLocalFileReader=function(b,c){b._localReader&&a.$setVisible(b._localReader,!1);b._readingLocal=!1;a._setCursor(b,c||0)};a._loadFileAsynchronously=function(b,c,d,e){if(0!=d.indexOf("?")){var h=d;d=a._checkFileName(c,d);var l=function(c){a._setData(b,d,h,c,e)},l=a._checkCache(c,d,l);0<=d.indexOf("|")&&(d=d.split("|")[0]);return null==l?null:a._getFileData(d,l)}if(!a.featureDetection.hasFileReader)return b.setData("Local file reading is not enabled in your browser",
null,null,e);c._localReader||(l='<div id="ID" style="z-index:'+a._getZ(c,"fileOpener")+';position:absolute;background:#E0E0E0;left:10px;top:10px"><div style="margin:5px 5px 5px 5px;"><input type="file" id="ID_files" /><button id="ID_loadfile">load</button><button id="ID_cancel">cancel</button></div><div>',a.$after("#"+c._id+"_appletdiv",l.replace(/ID/g,c._id+"_localReader")),c._localReader=a.$(c,"localReader"));a.$appEvent(c,"localReader_loadfile","click");a.$appEvent(c,"localReader_loadfile","click",
function(){var d=a.$(c,"localReader_files")[0].files[0],h=new FileReader;h.onloadend=function(h){h.target.readyState==FileReader.DONE&&(a._hideLocalFileReader(c,3),a._setData(b,d.name,d.name,h.target.result,e))};try{h.readAsArrayBuffer(d)}catch(l){alert("You must select a file first.")}});a.$appEvent(c,"localReader_cancel","click");a.$appEvent(c,"localReader_cancel","click",function(){a._hideLocalFileReader(c);b.setData("#CANCELED#",null,null,e)});a.$setVisible(c._localReader,!0);c._readingLocal=
!0};a._setData=function(b,c,d,e,h){e=a._strToBytes(e);0<=c.indexOf(".jdx")&&a.Cache.put("cache://"+c,e);b.setData(c,d,e,h)};a._doAjax=function(b,c,d){b=b.toString();if(null!=d)return a._saveFile(b,d);c&&(b+="?POST?"+c);return a._getFileData(b,null,!0)};a._saveFile=function(b,c,d,e){if(a._localFileSaveFunction&&a._localFileSaveFunction(b,c))return"OK";b=b.substring(b.lastIndexOf("/")+1);d||(d=0<=b.indexOf(".pdf")?"application/pdf":0<=b.indexOf(".png")?"image/png":0<=b.indexOf(".gif")?"image/gif":0<=
...
e)};a.getChemicalInfo=function(l,j,e){j||(j="name");"string"!=typeof l&&(l=l._getSmiles());return a._getNCIInfo(l,j,e)};a.saveImage=function(a){switch(a._viewType){case "Jmol":a._script('write PNGJ "'+a._id+'.png"');break;case "JSV":a._script("write PDF");break;case "JME":a._script("print")}}})(Jmol);
...
b.getClasspathFor(c);l=e[m];if(!l)for(j=E.length;0<=--j;)if(E[j].path==m||E[j].name==c){l=!0;break}if(l){if(g&&(l=H(c)))if(l.onLoaded){if(g!=l.onLoaded){var q=l.onLoaded,r=g;l.onLoaded=function(){q();r()}}}else l.onLoaded=g}else{l=a.unloadedClasses[c]&&H(c)||new y;l.name=c;l.path=m;l.isPackage=m.lastIndexOf("package.js")==m.length-10;Z(m,c,l);l.onLoaded=g;l.status=y.STATUS_KNOWN;c=!1;for(j=E.length;0<=--j;)if(E[j].status!=y.STATUS_LOAD_COMPLETE){c=!0;break}if(l.isPackage){for(j=E.length;0<=--j&&!E[j].isPackage;)E[j+
...
d);M=!0;ra=!1;b._checkLoad&&System.out.println("\t"+d+(g?"\n -- required by "+g:"")+"  ajax="+M+" async="+ra);g=d;a._debugging&&(d=d.replace(/\.z\.js/,".js"));j||System.out.println("loadScript "+d);b.onScriptLoading(d);if(M&&!ra){var q=m._getFileData(d);try{T(d,g,q,j)}catch(r){alert(r+" loading file "+d+" "+c.name+" "+a.getStackTrace())}l&&l()}else c={dataType:"script",async:!0,type:"GET",url:d,success:ba(d,!1,l),error:ba(d,!0,l)},h++,j?setTimeout(c.success,0):m.$ajax(c)},ba=function(c,d,e){a.getStackTrace();
return function(){g&&this.timeoutHandle&&(window.clearTimeout(this.timeoutHandle),this.timeoutHandle=null);0<h&&h--;this.onerror=this.onload=null;d&&alert("There was a problem loading "+c);b.onScriptLoaded(c,!0);var a=this,j;j=e?function(){X(a);sa(c,e)}:function(){X(a);sa(c)};0<=Y?window.setTimeout(function(){sa(c,j)},Y):sa(c,j)}},ha=!0,ga=!1,sa=function(c,g){var l=S["@"+c];if(l){var m,q=D["$"+c];if(q)for(var r=0;r<q.length;r++){var t=q[r];if(t!=l.name&&(m=H(t)))m.status<y.STATUS_CONTENT_LOADED&&
(m.status=y.STATUS_CONTENT_LOADED,updateNode(m));else{m=new y;m.name=t;var w=D["#"+t];w||(alert(t+" J2S error in tryToLoadNext"),error("Java2Script implementation error! Please report this bug!"));m.path=w;Z(m.path,t,m);m.status=y.STATUS_CONTENT_LOADED;Ja(d,m,!1);updateNode(m)}}if(l instanceof Array)for(r=0;r<l.length;r++)l[r].status<y.STATUS_CONTENT_LOADED&&(l[r].status=y.STATUS_CONTENT_LOADED,updateNode(l[r]));else if(l.status<y.STATUS_CONTENT_LOADED){m=!1;q=document.getElementsByTagName("SCRIPT");
for(r=0;r<q.length;r++)if(s){if(q[r].onreadystatechange&&q[r].onreadystatechange.path==l.path&&"interactive"==q[r].readyState){m=!0;break}}else if(q[r].onload&&q[r].onload.path==l.path){m=!0;break}m||(l.status=y.STATUS_CONTENT_LOADED,updateNode(l))}if(b.keepOnLoading){r=!0;if(m=Ka(y.STATUS_KNOWN))for(R(m);h<j&&(m=Ka(y.STATUS_KNOWN));)R(m);else if(0!=E.length)m=E.shift(),!e[m.path]||0!=E.length||!ha||m.musts.length||m.optionals.length?(Ja(d,m,!0),W(m,m.path,m.requiredBy,!1)):ha&&(ha=!1);else if(m=
G(y.STATUS_KNOWN))for(R(m);h<j&&(m=G(y.STATUS_KNOWN));)R(m);else r=!1;if(!(r||0<h)){l=[Ka,G];q=null;for(r=0;2>r;r++)for(;m=l[r](y.STATUS_CONTENT_LOADED);)1==r&&q===m&&(m.status=y.STATUS_LOAD_COMPLETE),updateNode(m),q=m;for(;!(ma=[],!na(d,c)););for(r=0;2>r;r++)for(q=null;(m=l[r](y.STATUS_DECLARED))&&q!==m;)updateNode(q=m);q=[];for(r=0;2>r;r++)for(;m=l[r](y.STATUS_DECLARED);)q.push(m),m.status=y.STATUS_LOAD_COMPLETE;if(q.length){for(r=0;r<q.length;r++)Da(q[r]);for(r=0;r<q.length;r++)if(l=q[r].onLoaded)q[r].onLoaded=
...
"red")};X.err.println=function(a){C.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};X.err.write=function(a,b,c){X.err.print(String.instantialize(a).substring(b,b+c))}}(Clazz,Jmol))};Jmol.___JmolDate="$Date: 2016-04-14 16:44:23 -0500 (Thu, 14 Apr 2016) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.4.4_2016.04.14";
